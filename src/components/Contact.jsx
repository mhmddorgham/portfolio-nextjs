...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      ...
      .catch((err) => {
        setLoading(false);
        Swal.fire({
          title: "Error During send message",
          text: "send us email on mhmddorgham10@gmail.com",
          icon: "error",
        });
        console.log("err:: ", err);
      });
  ...
  const onButtonClick = () => {
    ...
    fetch("mohamed_dorgham_cv.pdf").then((response) => {
        ...
        <div className="grid lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-3 lg:col-span-2 w-full h-full shadow-xl shadow-gray-400 rounded-xl p-4">
            <div className="lg:p-4 h-full ">
              ...
              <div>
                <h2 className="py-2">Mohamed Dorgham</h2>
              ...
              <form ref={form} onSubmit={sendEmail}>
                ...
                >
                  {loading ? (
                    <svg
                      aria-hidden="true"
                      className="w-8 h-8 text-gray-100 animate-spin dark:text-gray-100 fill-blue-600"
                      viewBox="0 0 100 101"
                      fill="none"
